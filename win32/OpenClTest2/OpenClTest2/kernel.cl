__kernel void Convolve(const __global float * InImage, const uint width, const uint height, __constant float * Filter, __global float * OutImage, const uint FilterWidth)
{
